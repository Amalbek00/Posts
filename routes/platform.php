...
Route::screen('/comments/create', \App\Orchid\Screens\Comment\CommentEditScreen::class)
    ->name('platform.comments.create');


Route::screen('/comments/{comment?}', \App\Orchid\Screens\Comment\CommentEditScreen::class)
    ->name('platform.comments.edit');

Route::screen('/photos', \App\Orchid\Screens\Photo\PhotoListScreen::class)
    ->name('platform.photos.list')
    ->breadcrumbs(fn(Trail $trail) => $trail
        ->parent('platform.index')
        ->push('Photos'));

Route::screen('/photos/create', \App\Orchid\Screens\Photo\PhotoEditScreen::class)
    ->name('platform.photos.create');


Route::screen('/photos/{photo?}', \App\Orchid\Screens\Photo\PhotoEditScreen::class)
    ->name('platform.photos.edit');
